    ...
    class ReporteSemanal
    {
        public void imprimir(DataGridView dtg)
        {
            ...
            doc.PrintPage += delegate (object ev, PrintPageEventArgs ep)
            {
                ...
                ep.Graphics.DrawString("REPORTE DE VENTAS ULTIMOS 7 DIAS ", new Font("Segoe UI", 16, FontStyle.Bold), Brushes.DeepSkyBlue, left, top);
                DateTime today = DateTime.Now;
                DateTime weekAgo =     DateTime.Today.AddDays(-7);

                top += DGV_ALTO;
                ep.Graphics.DrawString("FECHA: Del  " + weekAgo + "al " + today, new Font("Segoe UI", 16, FontStyle.Bold), Brushes.Gray, left, top);
                top += DGV_ALTO + 15;
